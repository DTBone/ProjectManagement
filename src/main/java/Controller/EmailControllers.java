...
public class EmailControllers extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (InputValidator.isValid(TieuDeGui) && InputValidator.isValid(NoiDung) && InputValidator.isValid(MaGV) )
		{
			String NguoiNhan = "";
			try {
		...
		{
			response.sendError(HttpServletResponse.SC_FORBIDDEN, "Input isn't validate.");
		}
