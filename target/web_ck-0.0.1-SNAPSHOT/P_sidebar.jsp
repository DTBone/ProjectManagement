...
<body>
	...
	<script>
		...
		function performFunction1() {
			...
			window.location.href = contextPath + "/danhsachdetaidk";
			// Thêm logic cho chức năng 1
		}

		function performFunction2() {
			window.location.href = contextPath + "/xemdexuatdetai";
			// Thêm logic cho chức năng 2
		}

		function performFunction3() {
			window.location.href = contextPath + "/danhsachdonxin";
			// Thêm logic cho chức năng 3
		}
		function performFunction4() {
			window.location.href = contextPath + "/danhsachdot";
			// Thêm logic cho chức năng 4
		}
	</script>
